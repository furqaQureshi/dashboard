            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <a href="/profile.php" class="btn btn-success float-end">Add Book</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal form-material">
                                            ...
                                            <input type="hidden" name="id" placeholder="Book Title" value="<?php echo $id ?>">
                                                <label class="col-md-12 p-0">Book Title</label>
                                                <div class="col-md-12 border-bottom p-0">
                                                    <input type="text" name="title" placeholder="Book Title" class="form-control p-0 border-0" value="<?php echo $title ?>">
                                                </div>
                                            </div>
                                            <div class="form-group mb-4">
                                                <label class="col-md-12 p-0">Book Auther</label>
                                                <div class="col-md-12 border-bottom p-0">
                                                    <input type="text" name="auther" placeholder="Book Auther" class="form-control p-0 border-0" value="<?php echo $auther ?>">
                                                </div>
                                            </div>
                                            <div class="form-group mb-4">
                                                <label class="col-md-12 p-0">Book Price</label>
                                                <div class="col-md-12 border-bottom p-0">
                                                    <input type="number" name="price" placeholder="Book Price" class="form-control p-0 border-0 " value="<?php echo $price ?>">
                                                </div>
                                            </div>
                                            <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <div class="form-group mb-4">
                                                <div class="col-sm-12">
                                                    <button class="btn btn-success" name="submit">Edit Book</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
